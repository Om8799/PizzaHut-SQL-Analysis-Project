...
2. Import and execute `combined_database_pizzahut.sql` to create the database and tables.
3. Load the CSV data into corresponding tables (if not already done).
4. Open and run queries from `combined_solution_code.sql` to view the analytical results.
